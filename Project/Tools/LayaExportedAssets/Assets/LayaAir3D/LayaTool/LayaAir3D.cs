...
public class LayaAir3D : EditorWindow
{
    ...
    private void Update()
    {
        ...
        if (configEnum == ConfigEnum.Scene)
            curConfigIndex = 1;
        else if(configEnum == ConfigEnum.Character)
            curConfigIndex = 2;
        else if (configEnum == ConfigEnum.Equip)
            curConfigIndex = 3;
        else if (configEnum == ConfigEnum.Particle)
            curConfigIndex = 4;
    ...
    private static void readConfiguration(bool readConfig)
    {
        ...
        if (readConfig)
        {
            ...
            {
                case 1:
                    configEnum = ConfigEnum.Scene;
                    break;
                case 2:
                    configEnum = ConfigEnum.Character;
                    break;
                case 3:
                    configEnum = ConfigEnum.Equip;
                    break;
                case 4:
                    configEnum = ConfigEnum.Particle;
                    break;
                case 5:
