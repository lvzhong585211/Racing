...
export class Reader {
    ...
    /**
     * 读取剩余的数据到一个utf8格式的字符串
     */
    public rawstring():string;

    /**
     * 直接读取一个包含对象的数组
     * @param decode 指定数组中对象的解压函数
     */
    public array<T>(decode:{(reader: ($protobuf.Reader|Uint8Array), length?: number)}):Array<T>;
...
export class Writer {
    ...
    /**
     * Writes a raw string without the length.
     * @param value Value to write
     * @returns `this`
     */
    public rawstring(value: string): Writer;
