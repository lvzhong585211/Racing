...
var MyUI;
(function (MyUI) {
    class FunOpenTiShiPart extends ui.FunOpenTiShi.FunOpenTiShiPartUI {
        constructor() {
            super();
        ...
        */
         ...
         * @returns {}
         */
        initPartData(openId, taskNums, pickUpState) {
            this.registerEventListeners();
            this.funOpenId = openId;
            this.funOpenTaskNums = taskNums;
            let goodsRewar = "";
            let goodsDataStr; // 物品奖励Str
                            ...
                            if (goodVo !== null && goodVo !== undefined) {
                                if (isOcc) {
                                    ...
                                    if (gameIns.gameState.roleData.Occupation === goodVo.MainOccupation) {
                                        const goodData = Global.GetDummyGoodsDataMu(parseInt(str[0]), parseInt(str[3]), parseInt(str[4]), parseInt(str[6]), parseInt(str[5]), parseInt(str[2]), parseInt(str[1]));
    ...
    MyUI.FunOpenTiShiPart = FunOpenTiShiPart;
})(MyUI || (MyUI = {}));
//# sourceMappingURL=FunOpenTiShiPart.js.map