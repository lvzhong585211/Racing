...
(function (MyUI) {
    ...
    (function (Welfare) {
         ...
         * 7日登陆 Part
         */
        class SevenDayLoginPart extends ui.Welfare.SevenDayLoginPartUI {
            constructor() {
                super();
                this.init();
            }
            ...
            destroy(destroyChild) {
                ...
                if (this.mCharacterView)
                    this.mCharacterView.destroy(destroyChild);
                if (this.mUiScene)
                    this.mUiScene.destroy(destroyChild);
            ...
            showInfo(sevenDayData) {
                ...
                let sevenDayRewardItem;
                // 记录每一天登陆奖励信息
                let sevenDayItemData;
                for (let i = 0; i < numLen; i++) {
                    sevenDayRewardItem = this._listSevenDay.getChildAt(i);
                    if (sevenDayRewardItem instanceof MyUI.SevenDayLoginRewardItem) {
            ...
            initData() {
                tableMgr.sevenDayLoginTable.AllRows().forEach((sevenDayVo, index) => {
                    const sevenDayItem = new MyUI.SevenDayLoginRewardItem();
            ...
            rewardGet(position) {
                ...
                for (let i = 0; i < rewardListLen; i++) {
                    ...
                    if (dayRewardItem instanceof MyUI.SevenDayLoginRewardItem) {
                        //记录当前item的领取状态
        ...
        Welfare.SevenDayLoginPart = SevenDayLoginPart;
    })(Welfare = MyUI.Welfare || (MyUI.Welfare = {}));
})(MyUI || (MyUI = {}));
//# sourceMappingURL=SevenDayLoginPart.js.map