...
(function (MyUI) {
    ...
    (function (Welfare) {
         ...
         * 福利-潜心修炼界面
         */
        class MeditationPart extends ui.Welfare.MeditationPartUI {
            constructor() {
                super();
                this.ProgHeight = 170; // 进度总高度
                this.UseGoldPerMinite = 0; // 每分钟需要金币数
                this.UseZuanShiPerMinite = 0; // 每分钟需要钻石数
                this.mEarningExp = 0; // 经验收益
                this.mEarningXingHun = 0; // 星魂收益
                this.mNeedMoney = 0; // 领取需要的花费
                ...
                this._btnGet.clickHandler = new MyUI.OpIntervalHandler(500, this, this.onGetButtonClick, null, false);
            ...
            onMeditationSecsNotify() {
                ...
                if (nSelectedIdx === 0) { // 1倍
                    ...
                    nMultiple = 2;
                    this._imgMoney.skin = Global.getMoneyImagePath(AwardsTypes.BindJinBi);
                    this.mNeedMoney = nTotalSecs / 60 * this.UseGoldPerMinite | 0;
                    this._txtMoney.text = `${this.mNeedMoney}`;
                    this._txtMoney.color = gameIns.gameState.roleData.Money1 < this.mNeedMoney ? `#${MyUI.ColorCode.no}` : `#${MyUI.ColorCode.value}`;
                }
                else if (nSelectedIdx === 2) { // 4倍
                    nMultiple = 4;
                    this._imgMoney.skin = Global.getMoneyImagePath(AwardsTypes.ZuanShi);
                    this.mNeedMoney = nTotalSecs / 60 * this.UseZuanShiPerMinite | 0;
                    this._txtMoney.text = `${this.mNeedMoney}`;
                    this._txtMoney.color = gameIns.gameState.roleData.UserMoney < this.mNeedMoney ? `#${MyUI.ColorCode.no}` : `#${MyUI.ColorCode.value}`;
                }
                // 更新收益显示
        ...
        Welfare.MeditationPart = MeditationPart;
    })(Welfare = MyUI.Welfare || (MyUI.Welfare = {}));
})(MyUI || (MyUI = {}));
//# sourceMappingURL=MeditationPart.js.map