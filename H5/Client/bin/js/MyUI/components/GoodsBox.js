...
(function (MyUI) {
    ...
    class GoodsBox {
        constructor() {
            this.m_bEnableMouse = true; // 是否激活鼠标响应
            this.m_nScrollStartIndex = 0; // 滚动开始的格子Index
        }
        /** 是否激活鼠标响应，默认为true */
        set enableMouse(value) { this.m_bEnableMouse = value; }
        /** 处理鼠标事件 */
        set mouseEventHandler(value) { this.m_handlerMouseEvent = value; }
        /** 处理翻页函数 */
        set pageChangeHandler(value) { this.m_handlerPageChange = value; }
        /** 设置/获取该Box管理的道具List */
        get list() { return this.m_lstGoodsIcon; }
        set list(value) {
            ...
            value.itemRender = MyUI.GoodsIcon;
        ...
        _onMouseHandler(e, nIdx) {
            if (!this.m_bEnableMouse)
                return;
            ...
            if (this.m_handlerMouseEvent) {
                ...
                MyUI.GTipServiceEx.ShowTip(this.m_lstGoodsIcon.getCell(nIdx), TipTypes.GoodsText, GoodsOwnerTypes.SelfBag, this.m_lstGoodsIcon.getItem(nIdx).goodsData);
            }
        }
        /**
         * 滚动开始
        ...
        findByGoodsDbID(dbID) {
            const aSources = this.m_lstGoodsIcon.array;
            aSources.find(value => value.goodsData && value.goodsData.Id === dbID);
        }
        destroy() {
    ...
    MyUI.GoodsBox = GoodsBox;
})(MyUI || (MyUI = {}));
//# sourceMappingURL=GoodsBox.js.map