...
(function (MyUI) {
     ...
     * 7日登陆每日奖励Item
     */
    class SevenDayLoginRewardItem extends ui.Welfare.Components.SevenLoginRewardItemUI {
        constructor() {
            super();
            // 未开启状态
            this.mRewardGiftGainState = JieRiRewardGiftGainState.NotNeedGain;
            // 第几天
            this.mDays = 1;
            this.init();
        }
        ...
        set itemDays(value) { this.mDays = value; }
        /**
         * 奖励领取状态
         */
        get jieRiRewardGiftGainState() { return this.mRewardGiftGainState; }
        set jieRiRewardGiftGainState(value) {
            ...
            if (this._imgNoGet.visible) {
                this._labDays.color = `#${MyUI.ColorCode.sevenDayNoActive}`;
            }
            else {
                this._labDays.color = `#${MyUI.ColorCode.sevenDayActive}`;
            }
        }
        /**
         * 显示每日奖励内容
        ...
        initDayData(sevenDayVo) {
            ...
            this.goodsData = Global.GetDummyGoodsDataMu(goodsId, parseInt(goodsDataList[3]), parseInt(goodsDataList[4]), parseInt(goodsDataList[6]), parseInt(goodsDataList[5]), parseInt(goodsDataList[2]), parseInt(goodsDataList[1]));
            // 物品图标显示
        ...
        clickGoods() {
            if (this.jieRiRewardGiftGainState === JieRiRewardGiftGainState.CanGain)
                ...
                MyUI.GTipServiceEx.ShowTip(null, TipTypes.GoodsText, GoodsOwnerTypes.SysGifts, this.goodsData);
        }
    }
    MyUI.SevenDayLoginRewardItem = SevenDayLoginRewardItem;
})(MyUI || (MyUI = {}));
//# sourceMappingURL=SevenDayLoginRewardItem.js.map