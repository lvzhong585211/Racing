...
(function (MyUI) {
    ...
    * Vip界面
    */
    class VipPart extends ui.Vip.VipPartUI {
        constructor() {
            super();
            this.init();
        }
        ...
        */
         ...
         * @returns {}
         */
        set vipRewardFlag(value) { this.vipRewardFlags = value; }
         ...
         * @returns {}
         */
        setVipData(levelExp, rewardFlag) {
        ...
        refreshVipData() {
            ...
            tableMgr.guiZuTable.AllRows().forEach((guiZuVo, index) => {
                const vipItem = new MyUI.VipItem();
    ...
    MyUI.VipPart = VipPart;
})(MyUI || (MyUI = {}));
//# sourceMappingURL=VipPart.js.map