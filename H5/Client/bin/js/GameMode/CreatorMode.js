...
(function (GameMode) {
     ...
     * @desc 创建角色模块
     */
    class CreatorMode extends GameMode.ModeBase {
        constructor() {
            super(EnumGameMode.Creator);
            this.actorsShow = []; // 保存待创建的职业的角色展示
            this.mPreModule = EnumGameMode.Invalid; // 保存从哪个模块跳转来的
        }
        ...
        _loadSceneAndActors() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield gameIns.loadPersistentLevel("xuanjue");
                if (!this.actorsShow) {
    ...
    GameMode.CreatorMode = CreatorMode;
})(GameMode || (GameMode = {}));
